...
public class UserController {
    ...
    public String registry(@ModelAttribute UserCreateEditDto user, RedirectAttributes redirectAttributes){
    ...
    @PatchMapping("/{id}")
    public String update(@PathVariable int id, @ModelAttribute UserCreateEditDto user){
